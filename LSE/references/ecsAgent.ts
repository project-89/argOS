...
const ecsCreateComponentType =
  ...
  ({ name, schema }: { name: string; schema: Schema }) => {
    componentMap[name] = defineComponent(schema);
    return "component created";
  };

const ecsCreateRelationType =
  (
    world: World,
    {
      components: componentMap,
...
const ecsAddComponents =
  ...
  ({ componentNames, entities }: AddComponentParams) => {
...
const ecsSetComponentValues =
  ...
  ({ setComponentValues, entities }: SetComponentValuesParams) => {
...
const ecsSetRelationValues =
  ...
  ({ setRelationValues, entities }: SetRelationValuesParams) => {
    for (const {
      relationName,
      relationSubjectEntityId,
      propertyValues,
    } of setRelationValues) {
...
const ecsGetComponentValues =
  ...
  ({ componentName, propertyNames, entityId }: GetComponentValuesParams) => {
    const obj: any = {};
    const component = componentMap[componentName];
...
const ecsAddRelations =
  ...
  ({ relationName, relationSubjects, entities }: AddRelationParams) => {
    const relation = relationMap[relationName];
    for (const eid of entities) {
...
const ecsQuery =
  ...
  ({
    ...
    const components = componentNames
      ? componentNames.map((name) => componentMap[name])
      : [];
    const notComponents = notComponentNames
      ? notComponentNames.map((name) => Not(componentMap[name]))
      : [];
    const relationPairs = relations
      ? relations.map(({ relationName, relationSubjectEntityId: entityId }) => {
          const eid =
      ...
      : [];
    const notRelationPairs = notRelations
      ? notRelations.map(
          ({ relationName, relationSubjectEntityId: entityId }) => {
            const eid =
              typeof entityId === "string"
                ? entityMap[entityId]
                : parseInt(entityId);
...
const ecsFilter =
  ...
  ({ componentFilters, entities }: FilterParams) => {
    return entities.filter((eid) => {
      for (const {
        ...
        const filter = {
          field: propertyName,
          operation: operationName as FilterOperations,
          values,
        } as FilterCriterion;
...
export const createAgent = (params: CreateAgentParams) => {
  ...
  const componentDefinitions = Object.entries(componentMap).reduce(
    (defs, [name, component]) => {
  ...
  const tools: ChatCompletionTool[] = [
        ...
        parameters: {
          ...
          properties: {
            componentNames: {
              ...
              enum: Object.keys(componentMap),
              description:
                "The array of components to remove from the entities.",
            },
            entities: {
              type: "array",
              items: { type: "number" },
              description:
                "The array of entities to remove the components from.",
            },
          },
          required: ["components", "entities"],
        },
    ...
    },
    {
      ...
      function: {
        name: "ecsQuery",
        description:
          "Queries the ECS game world for entities who have the passed in components on them.",
        parameters: {
          type: "object",
          properties: {
            componentNames: {
              type: "array",
              description:
                "An array of component names. DO NOT INCLUDE RELATIONS IN THIS PROPERTY",
              enum: Object.keys(componentMap),
            },
            notComponentNames: {
              type: "array",
        ...
        parameters: {
          ...
          properties: {
            ...
            relationSubjects: {
              ...
              items: { type: "number" },
              description:
                "The array of subject entity IDs to add the relation to.",
            },
            entities: {
              type: "array",
              items: { type: "number" },
        ...
        parameters: {
          ...
          properties: {
            ...
            relationSubjects: {
              ...
              items: { type: "number" },
              description:
                "The array of subject entity IDs to remove the relation from.",
            },
            entities: {
              type: "array",
              items: { type: "number" },
              description:
                "The array of entity IDs to remove the relation from.",
            },
          },
          required: ["relationName", "relationSubjects", "entities"],
        },
    ...
    },
    {
      ...
      function: {
        ...
        description:
          "Sets the values of various components for a list of entities.",
        parameters: {
          type: "object",
          properties: {
            setComponentValues: {
              ...
              items: {
                ...
                properties: {
                  componentName: {
                    type: "string",
                    description:
                      "The name of the component whose values are to be set.",
                  },
                  propertyValues: {
                    type: "array",
                    items: {
                      ...
                      properties: {
                        propertyName: {
                          type: "string",
                          description:
                            "The name of the property to set a value for.",
                        },
                        propertyValue: {
                          type: ["number", "string"],
                    ...
                    description:
                      "An array of property values to be set for the component.",
                  },
                },
                required: ["componentName", "propertyValues"],
                description:
                  "Specifies a component and the values to be set for its properties.",
              },
            ...
            entities: {
              ...
              description:
                "The array of entities to update the component values for.",
            },
          },
          required: ["setComponentValues", "entities"],
          description:
            "The parameters required to set component values for entities.",
        },
      },
    },
    {
      ...
      function: {
        ...
        description:
          "Sets the values of various relations for a list of entities.",
        parameters: {
          type: "object",
          properties: {
            setRelationValues: {
              ...
              items: {
                ...
                properties: {
                  ...
                  relationSubjectEntityId: {
                    type: "number",
                    description:
                      "The entity ID that is the subject of the relation.",
                  },
                  propertyValues: {
                    type: "array",
                    items: {
                      ...
                      required: ["propertyName", "propertyValue"],
                      description:
                        "A list of property names and their corresponding values to be set within the relation.",
                    },
                    description:
                      "An array of property values related to the specified relation.",
                  },
                },
                required: [
                  "relationName",
                ...
                description:
                  "Specifies a relation and the values to be set for its properties.",
              },
              description:
                "An array of relations and their new values to be set for specified entities.",
            },
            entities: {
              type: "array",
              items: {
              ...
              description:
                "The array of entities to which the relation values updates apply.",
            },
          },
          required: ["setRelationValues", "entities"],
          description:
            "The parameters required to set relation values for entities.",
        },
      },
    },
    {
      ...
      function: {
        ...
        description:
          "Retrieves the values of specified properties from a component of an entity.",
        parameters: {
          type: "object",
          properties: {
            componentName: {
              type: "string",
              description:
                "The name of the component from which values are to be retrieved.",
            },
            propertyNames: {
              type: "array",
              items: {
                type: "string",
                description:
                  "The names of the properties whose values are to be retrieved.",
              },
              description:
                "An array of property names to retrieve values from within the component.",
            },
            entityId: {
              type: "number",
              description:
                "The ID of the entity from which component values are to be retrieved.",
            },
          },
          required: ["componentName", "propertyNames", "entityId"],
          description:
            "The parameters required to retrieve component values for an entity.",
        },
      },
    },
    {
      ...
      function: {
        ...
        description:
          "Retrieves the values of specified properties from a relation of an entity.",
        parameters: {
          type: "object",
          properties: {
            relationName: {
              type: "string",
              description:
                "The name of the relation from which values are to be retrieved.",
            },
            relationSubjectEntityId: {
              type: "number",
            ...
            propertyNames: {
              ...
              items: {
                type: "string",
                description:
                  "The names of the properties whose values are to be retrieved from the relation.",
              },
              description:
                "An array of property names to retrieve values from within the relation.",
            },
            entityId: {
              type: "number",
              description:
                "The ID of the entity involved in the relation from which values are to be retrieved.",
            },
          },
          required: [
            "relationName",
          ...
          description:
            "The parameters required to retrieve relation values for an entity.",
        },
      },
    },
    {
      ...
      function: {
        name: "ecsFilter",
        description:
          "Filters entities based on components and specific filter criteria.",
        parameters: {
          type: "object",
          properties: {
            componentFilters: {
    ...
    const messages: ChatCompletionMessageParam[] = [
      {
        ...
        content: `
            ...
            Filter operation names are: ${JSON.stringify(
              Object.keys(FilterOperationNames)
            )}
...
export const hydrateWithFunctionLogs = (
  world: World,
